...
def train(args, model, optimizer, epoch, trainloader, trainset, use_cuda, train_log, viz=None):
    model.train()
    correct = 0
    total = 0
...
def test(best_result, args, model, epoch, testloader, use_cuda, test_log, viz=None):
    model.eval()
    objective = 0.
    total = 0
