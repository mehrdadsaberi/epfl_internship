...
parser.add_argument('--colorspace', type=str, default='RGB', help='[Lab] or [RGB] for colorspace to use for l2, ssim model types')
...
if(opt.model in ['l2','ssim','wass-pot']):
	opt.batch_size = 1
...
elif(opt.model in ['l2','ssim','wass-pot', 'wass-sink']):
